...
export class PlaygroundComponent implements OnInit {
  ...
  d = new Date()
  users={name:'marwa', age:36}
  n = 1.0002541545484845454545
// flag=false
// monNum=""
...
//   result = this.posts
  ...
  // filterData(){
  //   this.result = this.posts.filter(p=> p.title.includes(this.monNum))
  // }

  // filter(){
  //   if(this.monNum=="") return this.posts
  //   else {
  //     let newData = this.posts.filter()
  //     return newData
  //   }
  // }
}
